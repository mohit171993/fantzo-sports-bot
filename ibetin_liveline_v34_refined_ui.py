...
.v33Content{padding:10px 12px 155px!important}.v33Market,.v33Sessions,.v33Snapshot,.v33Panel{border-radius:17px!important;margin-bottom:10px!important;border-color:#164262!important;background:linear-gradient(180deg,#07192b,#051422)!important;box-shadow:0 12px 28px rgba(0,0,0,.22)!important}.v33Market{padding:12px!important}.v33Head{margin-bottom:10px!important}.v33Head strong{font-size:18px!important}.v33Head small{font-size:9px!important}.v33Odds{gap:8px!important}.v33Odd{padding:10px!important;gap:8px!important;border-radius:13px!important}.v33Odd .miniMark{width:40px!important;height:40px!important;font-size:10px!important}.v33OddName{font-size:11px!important}.v33OddVal{font-size:27px!important;white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;font-variant-numeric:tabular-nums!important}.oddValue{white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;font-variant-numeric:tabular-nums!important}.v33Hist b{white-space:nowrap!important;overflow:hidden!important;text-overflow:ellipsis!important;font-variant-numeric:tabular-nums!important}.v33History{margin-top:8px!important;border-radius:11px!important}.v33Hist{padding:7px 4px!important}.v33Hist span{font-size:7px!important}.v33Hist b{font-size:13px!important;margin-top:2px!important}
...
(function(){
  ...
  function IBETIN_V34_ODDS_PRECISION_FIX(){
    try{
      document.querySelectorAll('.v33OddVal,.oddValue,.v33Hist b').forEach(function(el){
  ...
  try{
    ...
    openMatch=async function(m){safeWindowed();syncSafe();const r=await prevOpen(m);safeWindowed();syncSafe();IBETIN_V34_ODDS_PRECISION_FIX();setTimeout(()=>{safeWindowed();IBETIN_V34_ODDS_PRECISION_FIX();},80);setTimeout(()=>{safeWindowed();IBETIN_V34_ODDS_PRECISION_FIX();},250);return r;};
  }catch(e){}
  try{
...
def _self_test() -> None:
    ...
    checks = {
        ...
        'odds_precision_fix': 'IBETIN_V34_ODDS_PRECISION_FIX' in page and 'toFixed(2)' in page,
    }
